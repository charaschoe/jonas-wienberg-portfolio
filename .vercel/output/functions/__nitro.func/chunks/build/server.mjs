import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, ref, h, resolveComponent, computed, mergeProps, withCtx, createTextVNode, useSSRContext, provide, watch, Suspense, Fragment, unref, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from 'vue';
...
const _routes = [
  ...
  {
    name: "projects-balineum",
    path: "/projects/balineum",
    component: () => import('./balineum.vue.mjs')
  },
  {
    name: "projects",
    path: "/projects",
  ...
  {
    name: "projects-influenza",
    path: "/projects/influenza",
    component: () => import('./influenza.vue.mjs')
  },
  {
    name: "projects-konradai",
    path: "/projects/konradai",
    component: () => import('./konradai.vue.mjs')
  },
  {
    name: "projects-projectname",
    path: "/projects/projectname",
    component: () => import('./projectname.vue.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "border-b border-gray-100" }, _attrs))} data-v-274ba0b0><nav class="max-w-5xl mx-auto px-6 py-6" data-v-274ba0b0><div class="flex items-center justify-between" data-v-274ba0b0>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` JONAS WIENBERG `);
      } else {
        return [
          createTextVNode(" JONAS WIENBERG ")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`<div class="space-x-8" data-v-274ba0b0>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-274ba0b0"]]);
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Personal portfolio of Jonas Wienberg - Developer & Creator"
        },
        {
          name: "keywords",
...
export { _export_sfc as _, __nuxt_component_0$1 as a, server as s, useHead as u };
