...
const _lazy_IVmgSn = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_IVmgSn, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_IVmgSn, lazy: true, middleware: false, method: undefined }
];
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "30a11b01-6b5d-4399-baa3-886c1368402f",
